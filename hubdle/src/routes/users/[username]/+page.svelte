...
<PageContainer>
	...
	<div class="mt-6 grid gap-6">
		<div class="grid grid-cols-3 gap-4">
			...
			<button
				class="relative flex items-center justify-center gap-3 rounded-lg bg-base-200 p-4 transition-colors hover:bg-base-300"
			...
			>
				...
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="absolute right-2 bottom-2 h-3 w-3 opacity-40 transition-transform {showFriends ? 'rotate-180' : ''}"><path fill-rule="evenodd" d="M4.22 6.22a.75.75 0 0 1 1.06 0L8 8.94l2.72-2.72a.75.75 0 1 1 1.06 1.06l-3.25 3.25a.75.75 0 0 1-1.06 0L4.22 7.28a.75.75 0 0 1 0-1.06Z" clip-rule="evenodd" /></svg>
			</button>
