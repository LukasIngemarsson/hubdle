		...
		<div class="grid grid-cols-3 gap-4">
			...
			<div class="flex flex-col items-center justify-center gap-1 rounded-lg bg-base-200 p-4">
				{#if data.stats.favoriteGame && GAME_ICONS[data.stats.favoriteGame.id]}
					<img src={GAME_ICONS[data.stats.favoriteGame.id]} alt="" class="h-7 w-7 rounded" />
				{/if}
				<p class="text-2xl font-bold">{data.stats.favoriteGame?.name ?? '—'}</p>
